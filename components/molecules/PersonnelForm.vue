...
export default class PersonnelForm extends Vue {
  ...
  honorific: string = '';
  input() {
    this.$store.commit('quotation/set', { positionName: this.positionName });
    this.$store.commit('quotation/set', { staffName: this.staffName });
    this.$store.commit('quotation/set', { honorific: this.honorific });
  }
