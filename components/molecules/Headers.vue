<template>
  <v-row no-gutters
    ><v-col cols="5"><Customers /></v-col>
    <v-col cols="3"><BettingRate /></v-col>
    <v-col cols="3"><UnitPriceCategory /></v-col>
  </v-row>
</template>
<script lang="ts">
...
import UnitPriceCategory from '@/components/atoms/input/UnitPriceCategory.vue';
