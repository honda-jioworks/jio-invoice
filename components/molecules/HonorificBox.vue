  ...
  <v-container>
    <v-row>
      ...
      <v-col align-self="top" cols="3">
        <v-select :rules="serectRules" v-model="honorific" label="敬称" :items="keisyo"></v-select>
      </v-col>
    </v-row>
  </v-container>
</template>
...
@Component({})
export default class HonorificBox extends Vue {
  @PropSync('valueManager', { type: String })
  @PropSync('valueHonorific', { type: String })
  manager!: any;
  honorific!: any;
